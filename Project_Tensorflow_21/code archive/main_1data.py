...
logdir_rootroot = r'C:\Users\jp\TF_logs\Main\1data_' # for tensorboard
saveDIR_root = r'C:\Users\jp\Google Drive\TF_Predictions\Predictions_Tests\1data' # for CSV
...
if len(X_test) % (MinBatchMultiple*batchSize_multiple):
    raise ValueError('X_test size must be mutiple of mini batch size')
                    ...
                    if X_test.any():
                        ...
                        if not os.path.isfile(savepath_metrics):
                            with open(savepath_metrics, 'w', newline='') as csvfile:
                                ...
                                metric_writer.writerow([iteratin_id, len(preds), r2_valid,
